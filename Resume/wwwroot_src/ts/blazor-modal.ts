...
const hostingEnv = (document.querySelector("#hostingEnv") as HTMLInputElement).value; //.NET Core hosting environment
const blazorModal = new window["bootstrap"].Modal(document.getElementById("components-reconnect-modal"));

function closeBlazorModal() {
    blazorModal.hide();
};
window["blazor-modal"].CloseBlazorModal = closeBlazorModal;

function openBlazorModal() {
    blazorModal.show();
};
window["blazor-modal"].openBlazorModal = openBlazorModal;
